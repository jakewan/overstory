...
// rather than per-tool for two reasons: the statement is shared, and Claude Code shows
// a model only the first 2,048 characters of a tool description, which both readiness
// descriptions exceed. That limit is undocumented; it is reported in
// anthropics/claude-code#87650 and was seen truncating these descriptions. If it is
// lifted nothing here breaks, since the instructions reach the model either way.
