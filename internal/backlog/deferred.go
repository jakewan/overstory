...
// repository's own name counts. It is parsed from GitHub's plaintext body
// (bodyText), which keeps code spans and fenced blocks, so a reference quoted as
// code is parsed too. bodyText
