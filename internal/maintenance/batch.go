...
// budget here is the REST core pool (requests/hour), not the GraphQL points pool
// — mapping per batch through this wrapper is what keeps the two pools from ever
